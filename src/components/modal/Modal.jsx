...
export default function Modal({ name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, buyNow, grandTotal }) {
    ...
    const handleRazorpayPayment = () => {
        ...
        if (!name || !address || !pincode || !phoneNumber) {
            return; // buyNow already handles the toast for empty fields
        }

        const options = {
            key: "rzp_test_Shj5MxcBSrMNcX", // 🔑 Replace with your Razorpay Test Key ID
            amount: grandTotal * 100,          // Razorpay expects amount in paise
            currency: "INR",
            name: "Bookie Store",
            description: "Order Payment",
            handler: function (response) {
                // Payment successful — response.razorpay_payment_id is the real ID
                buyNow(response.razorpay_payment_id);
                closeModal();
            },
            prefill: {
                name: name,
            ...
            theme: {
                color: "#7c3aed", // violet-600 to match your UI
            },
            modal: {
                ondismiss: function () {
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto lg:py-0">
                                            <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    {/* ✅ Now triggers Razorpay instead of direct buyNow */}
                                                    <button
